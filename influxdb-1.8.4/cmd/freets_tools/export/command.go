...
import (
	...
	"influxdb.cluster/cmd/freets_tools/internal/format"
	"influxdb.cluster/cmd/freets_tools/internal/format/binary"
	"influxdb.cluster/cmd/freets_tools/internal/format/line"
	"influxdb.cluster/cmd/freets_tools/internal/format/text"
