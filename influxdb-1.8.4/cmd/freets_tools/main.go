...
import (
	...
	"influxdb.cluster/cmd/freets_tools/compact"
	"influxdb.cluster/cmd/freets_tools/export"
	"influxdb.cluster/cmd/freets_tools/help"
	"influxdb.cluster/cmd/freets_tools/importer"
	"influxdb.cluster/cmd/freets_tools/server"
	metaRun "influxdb.cluster/cmd/freetsd-meta/run"
	dataRun "influxdb.cluster/cmd/freetsd/run"
