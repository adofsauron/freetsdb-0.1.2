...
import (
	...
	"influxdb.cluster/cmd/freetsd-ctl/backup"
	"influxdb.cluster/cmd/freetsd-ctl/help"
	"influxdb.cluster/cmd/freetsd-ctl/node"
	"influxdb.cluster/cmd/freetsd-ctl/restore"
)
