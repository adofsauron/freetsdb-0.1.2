...
import (
	...
	"influxdb.cluster/pkg/file"
	"influxdb.cluster/services/influxql"
	"influxdb.cluster/services/meta/internal"
...
func (c *Client) CreateDataNode(httpAddr, tcpAddr string) (*NodeInfo, error) {
	...
	fmt.Printf("DEBUG: services:meta:client:CreateDataNode, httpAddr = %s, tcpAddr = %s ID = %d \n", httpAddr, tcpAddr, c.nodeID)
	return n, nil
}
...
func (c *Client) CreateMetaNode(httpAddr, tcpAddr string) (*NodeInfo, error) {
	...
	fmt.Printf("DEBUG: services:meta:client:CreateMetaNode, httpAddr = %s, tcpAddr = %s, ID = %d \n", httpAddr, tcpAddr, c.nodeID)
	return n, nil
}
...
func (c *Client) pollForUpdates() {
	for {
		...
		c.cacheData = data
		// fmt.Printf("DEBUG: services:meta:client:pollForUpdates update cacheData, idx = %d \n", idx)
