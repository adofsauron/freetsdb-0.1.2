...
import (
	...
	internal "influxdb.cluster/services/meta/internal"
...
func (data *Data) CreateDataNode(host, tcpHost string) error {
	...
	fmt.Printf("DEBUG: services:meta:CreateDataNode host = %s, tcpHost = %s , ID = %d \n", host, tcpHost, existingID)
	return nil
}
...
func (data *Data) CreateMetaNode(httpAddr, tcpAddr string) error {
	...
	fmt.Printf("DEBUG: services:meta:CreateMetaNode httpAddr = %s, tcpAddr = %s ID= %d \n", httpAddr, tcpAddr, existingID)
	return nil
}
